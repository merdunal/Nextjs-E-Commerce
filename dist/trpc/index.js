...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        limit: zod_1.z.number().min(4).max(100),
    ...
    getInfiniteProductsByCategory: trpc_1.publicProcedure
        .input(zod_1.z.object({
        limit: zod_1.z.number().min(4).max(100),
        cursor: zod_1.z.number().nullish(),
        ...
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var limit, cursor, category, payload, page, _c, items, hasNextPage, nextPage;
        var input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    limit = input.limit, cursor = input.cursor, category = input.category;
                    return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                case 1:
                    payload = _d.sent();
                    page = cursor || 1;
    ...
    searchProducts: trpc_1.publicProcedure
        ...
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var search, limit, cursor, payload, page, _c, items, hasNextPage, nextPage;
        var input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    search = input.search, limit = input.limit, cursor = input.cursor;
                    return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                case 1:
                    payload = _d.sent();
                    page = cursor || 1;
